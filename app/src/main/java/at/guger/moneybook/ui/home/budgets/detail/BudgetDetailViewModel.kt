...
class BudgetDetailViewModel(
    ...
    val transactions: LiveData<List<Transaction>> = transactionsRepository.getByAccount(budgetId)
    val transactionMonths: LiveData<List<LocalDate>> = transactionsRepository.getByAccountMonthly(budgetId)
