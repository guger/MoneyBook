 ...
 */
class AccountDetailTransactionViewHolder(binding: ItemTransactionBinding, private val viewModel: AccountDetailViewModel) : ModelViewHolder<ItemTransactionBinding, Transaction>(binding),
