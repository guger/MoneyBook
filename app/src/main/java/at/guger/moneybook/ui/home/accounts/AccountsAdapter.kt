 ...
 */
class AccountsAdapter(private val viewModel: HomeViewModel) : ListAdapter<Account, AccountViewHolder>(AccountsDiffCallback()) {
    ...
    class AccountsDiffCallback : DiffUtil.ItemCallback<Account>() {
