...
/**
 * [RecyclerView.ViewHolder] for an accounts overview item.
 */
class OverviewAccountsAccountViewHolder(binding: ItemAccountBinding, private val viewModel: HomeViewModel) : ModelViewHolder<ItemAccountBinding, Account>(binding) {
