 ...
 */
class DefaultAccountWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params), KoinComponent {

    private val repository: AccountsRepository by inject()

    override suspend fun doWork(): Result {
        repository.insert(DataUtils.getDefaultAccount(applicationContext))
